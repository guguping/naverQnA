...
<nav>
    <div id="nav-inner">
        ...
        <ul id="nav-list" style="display: flex;justify-content: center;">
            ...
            <li class="nav-menu" style="background-color: #00c73c;border: 1px solid #00bd39;margin-left: 15px;"><a
                    href="#" class="nav-list-item-question"><span class="btn_inner"><i
                    class="nav-list-item-question-icon"></i>질문하기</span></a></li>
        </ul>
    </div>
</nav>
